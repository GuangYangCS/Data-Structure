...
//			System.out.println("Hash table Maximum capavity : " + ht.capacity);
//			System.out.println("Hash table current capavity : " + ht.occupied);

			/*
			 * Rwhen load factor is larger than 0.5, automatically 
			 * double the prime size and rehashing
			 */
			if (ht.occupied > 0.5 * ht.capacity) {
				System.out.println("rehashing since load factor is more than 0.5 : ");

				int newCapacity = ht.doublePrime(capacity);
				System.out.println("Double the array size to a prime number : " + newCapacity);
